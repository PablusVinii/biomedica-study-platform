  ...
  return (
    ...
    >
      ...
      <div className="p-3 border-t border-border mt-auto">
        <button
          onClick={() => (window as any).setSelectedCourseId?.(null)}
          className={cn(
            "w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left transition-colors mb-2",
        ...
        >
          ...
          {!collapsed && (
            <span className="text-xs font-medium">Trocar Curso</span>
          )}
        </button>
        <button
